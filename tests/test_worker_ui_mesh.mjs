...
assert.match(html, /never share a socket/);
assert.match(html, /refuse live body sync/);
assert.match(html, /no neighbor vote-to-fix/);
...
assert.match(html, /id="downloadBtn"[^>]*href="\/download\?asset=azinterface-0\.1\.0\.tar\.gz"/);
