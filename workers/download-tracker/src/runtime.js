...
<p>Kernel: <a href="${FRAGGATE}">${FRAGGATE}</a> · AZHub (separate software): <a href="${AZHUB}">${AZHUB}</a> · AZCoherence (same FragGate door, slug=azcoherence): <a href="${AZCOHERENCE}">${AZCOHERENCE}</a></p>
