...
<footer>
  ...
  Suite mesh <code>/v1/mesh/*</code> PROXIES (AZIEL_RUNTIME or HTTPS). Live Nodes read-only. QNM-BUILD-1.0 rollup. QNS-CD-1.0 vias in local qnsd. SPLIT THE WIRES + COLD-COPY SURVIVAL. REHEAL refuse (isolate+local phoenix; no neighbor vote-to-fix). Not a Node Gate. Not a publish path. GET never enables.
