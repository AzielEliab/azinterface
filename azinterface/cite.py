...
def cite_document() -> dict[str, Any]:
    return {
        "author": IDENTITY,
        ...
        "fraggate_describe": f"{RUNTIME}/v1/fraggate/describe?slug=azinterface",
        "door": "fraggate",
        "sort_law": SORT_LAW,
        "sibling": AZHUB,
        ...
        "peers": [
            ...
            },
            {
                ...
                "fraggate_describe": f"{RUNTIME}/v1/fraggate/describe?slug=azcoherence",
                "fraggate_call": FRAGGATE_CALL,
                "one_line": (
                    "Second-pass triad coherence review (primary vs alternate → "
                    "PASS/FLAG/NEUTRALIZE/REFUSE). Peer of AZ-CLCE. Not AKM-TRIAD."
                ),
                "not": "AKM-TRIAD",
        ...
        "note": (
            ...
            "FragGate is THE single door. Agents use aziel-runtime MCP/FragGate; "
            "humans use this Worker UI + /download."
        ),
    }
